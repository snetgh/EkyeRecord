                        ...
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table table-hover mb-none" id="datatable-tabletools">
                                        <thead>
                                            <tr>
                                                <th>Full name</th>
                                                <th>Folder Number</th>
...
while ($patients_data = mysqli_fetch_array($get_patients_data)) {?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="actions-hover actions-fade">
                                                    <a
                                                        href="ed_patients.php?e=1&d=0&p=<?php echo $patients_data['patient_id'] ?>"><i
                                                            class="fa fa-pencil"></i></a>
                                                    <a href="ed_patients.php?e=0&d=1&p=<?php echo $patients_data['patient_id'] ?>"
                                                        class="delete-row"><i class="fa fa-trash-o"></i></a>

                                                    <a class="view_patient"
                                                        id="<?php echo $patients_data['patient_id'] ?>"><i
                                                            class="fa fa-eye"></i></a>
